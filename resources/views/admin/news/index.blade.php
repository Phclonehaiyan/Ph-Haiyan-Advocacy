@extends('admin.layouts.app', ['pageTitle' => 'News Editor'])
    ...
    <section class="admin-panel">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div class="max-w-3xl">
                ...
                <h2 class="admin-heading">News Archive</h2>
                <p class="admin-copy">Manage public updates and full story pages with a simpler editor than the generic resource form.</p>
            </div>
            ...
            <div class="flex flex-col gap-3 sm:flex-row">
                ...
                <a href="{{ route('admin.news.create') }}" class="btn-primary justify-center">
            ...
            <div class="overflow-x-auto">
                <table class="admin-table">
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="min-w-[18rem]">
                                        ...
                                        <div class="mt-2 text-sm text-slate-600">{{ \Illuminate\Support\Str::limit($record->excerpt, 120) }}</div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="flex flex-wrap gap-3">
                                        <a href="{{ route('admin.news.edit', $record) }}" class="inline-flex items-center gap-2 rounded-full border border-pine-200 bg-white px-3 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-pine-900 transition hover:border-pine-300 hover:bg-pine-50">
                                            <x-icon name="edit" class="h-3.5 w-3.5" />
                                            Edit
                                        </a>
                                        <form action="{{ route('admin.news.destroy', $record) }}" method="POST" onsubmit="return confirm('Delete this news story?');">
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-10 text-center text-sm text-slate-500">No news stories found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
